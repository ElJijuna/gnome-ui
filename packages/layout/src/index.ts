export type { ActivityFeedItem, ActivityFeedProps } from './components/ActivityFeed';
...
export type { IconBadgeColor, IconBadgeProps, IconBadgeSize } from './components/IconBadge';
...
export type { UserCardAction, UserCardProps } from './components/UserCard';
