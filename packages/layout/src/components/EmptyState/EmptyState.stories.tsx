...
export const WithIcon: Story = {
  ...
  parameters: {
    docs: {
      description: { story: 'Icon is rendered large and muted (40 % opacity) above the title.' },
    },
  },
};
...
export const WithAction: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Full empty state with icon, description, and a call-to-action button.',
      },
    },
  },
};
...
export const NoDescription: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Empty state without a description — common for search/filter contexts.',
      },
    },
  },
};
