...
describe('EmptyState', () => {
  ...
  describe('icon', () => {
    it('renders the icon slot when provided', () => {
      render(<EmptyState title="No files yet" icon={<svg data-testid="folder-icon" />} />);
  ...
  describe('action', () => {
    it('renders the action slot when provided', () => {
      render(
        <EmptyState title="No files yet" action={<Button variant="suggested">Add File</Button>} />,
      );
  ...
  describe('HTML attribute forwarding', () => {
    it('forwards className to the root element', () => {
      const { container } = render(<EmptyState title="No files yet" className="custom-empty" />);

      expect(container.firstChild).toHaveClass('custom-empty');
    });

    it('forwards arbitrary HTML attributes to the root element', () => {
      const { container } = render(<EmptyState title="No files yet" data-testid="empty-state" />);
