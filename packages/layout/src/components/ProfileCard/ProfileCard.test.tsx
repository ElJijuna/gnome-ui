...
describe('ProfileCard', () => {
  ...
  describe('status dot', () => {
    ...
    it.each([
      ...
      'away',
      'busy',
    ] as const)("renders a status dot with aria-label '%s'", (status) => {
  ...
  describe('loading', () => {
    it("renders with aria-busy='true' when loading", () => {
      const { container } = render(<ProfileCard name="rcronald" username="@rcronald" loading />);
    ...
    it("renders spinner when loadingType='spinner'", () => {
      render(<ProfileCard name="rcronald" username="@rcronald" loading loadingType="spinner" />);
  ...
  describe('interactive', () => {
    ...
    it('calls onClick when the interactive card is clicked', async () => {
      ...
      render(
        <ProfileCard name="rcronald" username="@rcronald" interactive onClick={handleClick} />,
      );
