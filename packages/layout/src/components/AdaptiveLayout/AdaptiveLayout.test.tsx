import { Add, Delete, Edit, GoHome } from '@gnome-ui/icons';
...
describe('AdaptiveLayout — desktop (sidebar)', () => {
  ...
  it('hides the collapse button when showCollapseButton=false', () => {
    render(
      <AdaptiveLayout items={ITEMS} value="home" onValueChange={vi.fn()} showCollapseButton={false}>
        <p>Content</p>
      </AdaptiveLayout>,
    );
  ...
  describe('sidebarPlacement=full', () => {
    it('renders without error', () => {
      render(
        <AdaptiveLayout items={ITEMS} value="home" onValueChange={vi.fn()} sidebarPlacement="full">
          <p>Content</p>
        </AdaptiveLayout>,
      );
  ...
  describe('background color', () => {
    ...
    it('applies rgba background when bgColor is omitted but bgOpacity < 1', () => {
      const { container } = render(
        <AdaptiveLayout items={ITEMS} value="home" onValueChange={vi.fn()} bgOpacity={0.5}>
          <p>Content</p>
        </AdaptiveLayout>,
      );
      const root = container.firstChild as HTMLElement;
    ...
    it('applies color-mix background when bgColor is set', () => {
      const { container } = render(
        <AdaptiveLayout items={ITEMS} value="home" onValueChange={vi.fn()} bgColor="blue">
          <p>Content</p>
        </AdaptiveLayout>,
      );
      const root = container.firstChild as HTMLElement;
    ...
    it('marks the root when glass is enabled', () => {
      const { container } = render(
        <AdaptiveLayout items={ITEMS} value="home" onValueChange={vi.fn()} glass>
          <p>Content</p>
        </AdaptiveLayout>,
      );
      const root = container.firstChild as HTMLElement;
