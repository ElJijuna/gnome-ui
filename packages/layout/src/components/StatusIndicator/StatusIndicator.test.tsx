...
describe('StatusIndicator', () => {
  ...
  describe('description', () => {
    it('renders description when provided', () => {
      render(<StatusIndicator status="warning" label="API" description="High latency" />);
  ...
  describe('status class', () => {
    it.each([
      ...
      'error',
      'loading',
    ] as const)("applies '%s' class to the dot", (status) => {
      const { container } = render(<StatusIndicator status={status} label="Service" />);
  ...
  describe('size class', () => {
    it("applies 'md' class by default", () => {
      const { container } = render(<StatusIndicator status="online" label="Service" />);
      const dot = container.querySelector("[role='img']");
    ...
    it("applies 'sm' class when size='sm'", () => {
      const { container } = render(<StatusIndicator status="online" label="Service" size="sm" />);
      const dot = container.querySelector("[role='img']");
