...
describe('PanelCard', () => {
  ...
  describe('header', () => {
    ...
    it('renders a ReactNode title', () => {
      render(
        <PanelCard title={<span data-testid="custom-title">Custom</span>}>{BODY_TEXT}</PanelCard>,
      );
    ...
    it('does not render an icon wrapper when icon is omitted', () => {
      const { container } = render(<PanelCard title={TITLE}>{BODY_TEXT}</PanelCard>);
    ...
    it('renders headerActions when provided', () => {
      render(
        <PanelCard title={TITLE} headerActions={<button type="button">Edit</button>}>
          {BODY_TEXT}
        </PanelCard>,
      );
  ...
  describe('footer', () => {
    ...
    it('renders footerActions when provided', () => {
      render(
        <PanelCard title={TITLE} footerActions={<button type="button">Save</button>}>
          {BODY_TEXT}
        </PanelCard>,
      );
  ...
  describe('imperative handle (ref)', () => {
    ...
    it('expand() fires onExpandedChange with true', () => {
      ...
      render(
        <PanelCard ref={ref} title={TITLE} defaultExpanded={false} onExpandedChange={onChange}>
          {BODY_TEXT}
        </PanelCard>,
      );
      act(() => ref.current?.expand());
  ...
  describe('loading', () => {
    ...
    it("renders skeleton when loadingType='skeleton' is explicit", () => {
      const { container } = render(
        <PanelCard title={TITLE} loading loadingType="skeleton">
          {BODY_TEXT}
        </PanelCard>,
      );
    ...
    it("renders spinner when loadingType='spinner'", () => {
      const { container } = render(
        <PanelCard title={TITLE} loading loadingType="spinner">
          {BODY_TEXT}
        </PanelCard>,
      );
    ...
    it('does not render spinner when not loading', () => {
      render(
        <PanelCard title={TITLE} loadingType="spinner">
          {BODY_TEXT}
        </PanelCard>,
      );
      expect(screen.queryByRole('status')).toBeNull();
