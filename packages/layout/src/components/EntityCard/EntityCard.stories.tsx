...
export const FollowingApps: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Compact grid cards — Following / Apps tab. No `badge`, no `description`.',
      },
    },
  },
};
...
export const FollowingMaintainers: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Compact grid cards — Following / Maintainers tab. Uses `<Avatar>` instead of `<IconBadge>`.',
      },
    },
  },
};
...
const APPS = [
  {
    ...
    name: 'GNOME Weather',
    status: 'published',
    desc: 'The official weather app for GNOME desktop.',
    version: 'v4.8.1',
    downloads: 12483,
  },
  {
...
export const MyApps: Story = {
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 8, width: 480 }}>
      {APPS.map((app) => (
        <EntityCard
          key={app.id}
          avatar={
            <IconBadge color={app.color as 'blue'} size="lg">
              {app.icon}
            </IconBadge>
          }
          title={app.name}
  ...
  parameters: {
    docs: {
      description: {
        story: 'Full-width list rows — MyApps screen. Uses `badge`, `trailing`, and `description`.',
      },
    },
  },
};
...
export const LoadingSkeleton: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Default loading state — skeleton for the avatar, title, and subtitle lines.',
      },
    },
  },
};
