...
describe('CounterCard', () => {
  ...
  describe('value display (animated=false)', () => {
    ...
    it('renders prefix and suffix together', () => {
      render(<CounterCard label="Cost" value={200} prefix="$" suffix=" USD" animated={false} />);
    ...
    it('respects the decimals prop when no custom format is provided', () => {
      render(<CounterCard label="Rate" value={Math.PI} decimals={2} animated={false} />);
  ...
  describe('aria-live region', () => {
    it("has aria-live='polite' and aria-atomic='true' on the value span", () => {
      const { container } = render(<CounterCard label="Files" value={10} animated={false} />);
    ...
    it('encodes label, prefix, final value, and suffix in the aria-label', () => {
      render(
        <CounterCard label="Revenue" value={9420} prefix="$" suffix=" USD" animated={false} />,
      );
  ...
  describe('accent variant', () => {
    it('does not apply an accent class by default', () => {
      const { container } = render(<CounterCard label="Files" value={5} animated={false} />);
      const liveRegion = container.querySelector("[aria-live='polite']");
  ...
  describe('loading', () => {
    ...
    it('does not render the label text when loading', () => {
      render(<CounterCard label="HiddenLabel" value={42} animated={false} loading />);
