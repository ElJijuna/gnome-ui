...
const FolderIcon = () => {
  return (
    <svg width="40" height="40" viewBox="0 0 40 40" fill="none" aria-hidden>
      <path
        d="M4 10a4 4 0 0 1 4-4h8l4 5h12a4 4 0 0 1 4 4v17a4 4 0 0 1-4 4H8a4 4 0 0 1-4-4V10Z"
  ...
  return (
    <svg width="40" height="40" viewBox="0 0 40 40" fill="none" aria-hidden>
      <rect
        ...
        stroke="var(--gnome-headerbar-border-color, rgba(0,0,0,.15))"
        strokeWidth="1.5"
      />
      <path
  ...
  return (
    <div style={{ display: 'flex', height: '100%' }}>
      ...
      <Toolbar style={{ flex: 1, minHeight: 'unset', height: '100%', padding: '0 8px', gap: 4 }}>
        ...
        >
          <PathBar segments={segments} onNavigate={onNavigate} style={{ width: '100%' }} />
        </div>
