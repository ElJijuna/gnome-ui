...
export const Dismissible: Story = {
  render: function DismissibleStory() {
    ...
    return visible ? (
      <Banner variant="warning" dismissible onDismiss={() => setVisible(false)}>
  ...
  parameters: {
    ...
    docs: {
      description: {
        story:
          'Set `dismissible` and handle `onDismiss` to remove the banner when the user closes it.',
      },
    },
  },
};
  ...
  render: function InContextStory() {
    ...
    return (
      ...
      >
        ...
        <div style={{ padding: 24, fontFamily: 'sans-serif', opacity: 0.5 }}>View content area</div>
      </div>
    );
  },
  parameters: {
