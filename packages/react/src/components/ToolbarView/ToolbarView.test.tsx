...
describe('ToolbarView', () => {
  ...
  it('renders topBar when provided', () => {
    render(
      <ToolbarView topBar={<header>Top</header>}>
        <p>Content</p>
      </ToolbarView>,
    );
  ...
  it('renders bottomBar when provided', () => {
    render(
      <ToolbarView bottomBar={<footer>Bottom</footer>}>
        <p>Content</p>
      </ToolbarView>,
    );
  ...
  it('renders all three slots simultaneously', () => {
    render(
      <ToolbarView topBar={<div>Header</div>} bottomBar={<div>Footer</div>}>
        <div>Body</div>
      </ToolbarView>,
    );
