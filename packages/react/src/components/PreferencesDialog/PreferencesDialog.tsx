...
export const PreferencesDialog = ({
  ...
  const pages = Children.toArray(children).filter((c): c is ReactElement<PreferencesPageProps> =>
    isValidElement(c),
  ...
  return createPortal(
    ...
    >
      <div
        ...
        className={[styles.dialog, multiPage ? styles.dialogMulti : null, className]
          .filter(Boolean)
          .join(' ')}
                ...
                {pages.map((page, i) => (
                  <li key={i} role="presentation">
                    <button
                      ...
                      className={[styles.navItem, i === activeIndex ? styles.navItemActive : null]
                        .filter(Boolean)
                        .join(' ')}
                    ...
                    >
                      {page.props.iconName && (
                        <span
                          className={[styles.navIcon, 'icon', page.props.iconName].join(' ')}
                          aria-hidden="true"
                        />
                      )}
                      <span className={styles.navLabel}>{page.props.title}</span>
                    </button>
                  </li>
                ))}
              </ul>
