import { Copy, Delete, Edit, Settings, Share, ViewMore } from '@gnome-ui/icons';
...
export const Placements: Story = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        story: 'All four placements. The panel flips when it would exceed the viewport.',
      },
    },
  },
};
...
export const Controlled: Story = {
  render: function ControlledStory() {
    ...
    return (
      <div style={{ display: 'flex', gap: 16, alignItems: 'center' }}>
        ...
        >
          <Button variant="flat" aria-label="Toggle">
            Toggle
          </Button>
        </Popover>
      </div>
  ...
  parameters: {
    ...
    docs: {
      description: {
        story:
          'Controlled mode — pass `open` + `onClose`. The external button can also open the popover.',
      },
    },
  },
};
...
export const ShareSheet: Story = {
  render: () => (
    ...
    >
      <Button leadingIcon={<Icon icon={Share} size="md" aria-hidden />}>Share</Button>
    </Popover>
  ),
  parameters: {
    controls: { disable: true },
