...
describe("SegmentedBar", () => {
  describe("rendering", () => {
    ...
    it("renders one segment per value", () => {
      const track = render(<SegmentedBar values={defaultValues} />).container.firstChild as HTMLElement;
  ...
  describe("proportional widths", () => {
    it("sets segment widths as percentage of total", () => {
      const track = render(
        <SegmentedBar values={[{ label: "A", value: 75 }, { label: "B", value: 25 }]} />,
    ...
    it("normalizes proportionally when values do not sum to 100", () => {
      const track = render(
        <SegmentedBar values={[{ label: "A", value: 1 }, { label: "B", value: 3 }]} />,
      ).container.firstChild as HTMLElement;
