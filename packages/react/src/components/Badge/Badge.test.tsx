...
describe('Badge', () => {
  ...
  describe('variants', () => {
    it.each([
      ...
      expect(container.querySelector('span')?.className).toMatch(new RegExp(variant));
    });
