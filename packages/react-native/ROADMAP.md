...
| ⬜ | **PasswordField** | Directly portable — `TextField` + reveal-icon toggle; `PasswordEntryRow` (Tier 12) has now shipped that exact recipe (`secureTextEntry` + an `IconButton` toggle) to copy from |
