...
port status in [`@gnome-ui/react-native`](./packages/react-native/ROADMAP.md)
and [`@gnome-ui/web-components`](./packages/web-components/ROADMAP.md):
...
Generated by [`scripts/generate-component-tables.mjs`](./scripts/generate-component-tables.mjs)
