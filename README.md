...
port status in [`@gnome-ui/react-native`](https://github.com/ElJijuna/gnome-ui/blob/main/packages/react-native/ROADMAP.md)
and [`@gnome-ui/web-components`](https://github.com/ElJijuna/gnome-ui/blob/main/packages/web-components/ROADMAP.md):
...
Generated by [`scripts/generate-component-tables.mjs`](https://github.com/ElJijuna/gnome-ui/blob/main/scripts/generate-component-tables.mjs)
