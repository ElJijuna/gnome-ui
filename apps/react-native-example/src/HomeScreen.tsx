...
const DESCRIPTIONS: Record<ComponentName, string> = {
  ...
  TagInput: 'Type-to-add multi-value input rendering entries as removable chips',
  ...
  SwitchRow: 'Activatable row with an integrated switch — press anywhere to toggle',
